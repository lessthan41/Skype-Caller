...
//            Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.ceco.face");
    ...
    protected void onResume() {
        ...
        if(!isNotificationServiceEnabled()){
            alertDialog = buildNotificationServiceAlertDialog();
            alertDialog.show();
        } else if (!Settings.canDrawOverlays(this)) {
            alertDialog = floatingWindowServiceAlertDialog();
            alertDialog.show();
        } else {
            MultiTask multiTask = new MultiTask();
            multiTask.execute();
            Toast.makeText(this, "Start working", Toast.LENGTH_SHORT).show();    // Show Message
        }
    }
     ...
     * Build Notification Listener Alert Dialog.
     */
    private AlertDialog floatingWindowServiceAlertDialog(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setTitle(R.string.floating_window_service);
        alertDialogBuilder.setMessage(R.string.floating_window_service_explanation);
        alertDialogBuilder.setPositiveButton(R.string.yes,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(ACTION_FLOATING_WINDOW_SETTINGS, Uri.parse("package:" + getPackageName())));
                    }
                });
        alertDialogBuilder.setNegativeButton(R.string.no,
                new DialogInterface.OnClickListener() {
